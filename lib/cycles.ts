...
export interface Cycle {
  key: string;
  label: string;
  /** Unicode planetary glyph for compact display. */
  glyph: string;
  /** length in years */
  yearLength: number;
